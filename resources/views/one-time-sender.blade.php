                                ...
                                <div class="card-body">
                                    <form action="{{ route('ots.import') }}" method="POST" name="importform"
                                        ...
                                        <div class="mt-4 form-group">
                                            <div class="az-content-label mg-b-5 mb-3">Job Name</div>
                                            <input id="sendername" name="sendername" class="form-control"
                                        ...
                                        <div class="mt-4 form-group">
                                            <div class="az-content-label mg-b-5 mb-3">ReplyTo</div>
                                            <input id="replyto" name="replyto" class="form-control"
                                                placeholder="Lorem ipsum dolor sit, amet consectetur adipisicing."
                                                type="text" spellcheck="false">
